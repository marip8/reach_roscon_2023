...
parameters = [
  ...
  {'name': 'config_name',                           'description': 'Reach study configuration name',                  'default': 'mobile_manipulation'},
  {'name': 'results_dir',                           'description': 'Directory in which to save reach study results',  'default': PathJoinSubstitution(['/tmp', 'reach_study'])},
]
...
def launch(context, *args, **kwargs):
    ...
    os.environ['REACH_PLUGINS'] = 'reach_ros_plugins:reach_roscon_2023_plugins'
